...
models=(
    "PINN 1D_PINNmodel 10000 0.01 2DPoisson 0 1000 Config/params.yml 1 0"
    "PINN 1D_PINNmodel 10000 0.01 2DPoisson 0 1000 Config/paramsAW.yml 1 1"
    "PINN 1D_PINNmodel 10000 0.01 2DPoisson 5 1000 Config/paramsAC.yml 1 0"
    "PINN 1D_PINNmodel 10000 0.01 2DPoisson 5 1000 Config/paramsACAW.yml 1 1"
)
